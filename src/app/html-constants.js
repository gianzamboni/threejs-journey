export const CLASS_TOKENS = {
  ...
  hover: "hover:bg-neutral-300 dark:hover:bg-netural-950 focus:outline-none focus:bg-neutral-300 dark:focus:bg-neutral-950",
  text: "dark:text-white"
}

export const MENU_BUTTON_CLASSES = `flex py-2 px-3 m-5 items-center gap-x-2 border border-slate-50 font-medium  rounded-md shadow-sm dark:text-white dark:border-neutral-800 ${CLASS_TOKENS.bg} ${CLASS_TOKENS.hover}`;
...
export const SIDE_BAR_CLASSES = `hs-overlay w-64 hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform h-full hidden fixed top-0 start-0 bottom-0 z-[60] border-e border-gray-200 ${CLASS_TOKENS.bg} dark:border-neutral-700`
...
export const YELLOW_STAR_ICON = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star-fill text-yellow-500" viewBox="0 0 16 16"><path d="M8 12.5l-3.5 2.5 1-4.1-3.4-2.9 4.2-.4L8 3.4l1.7 4.2 4.2.4-3.4 2.9 1 4.1L8 12.5z"/></svg>`;
