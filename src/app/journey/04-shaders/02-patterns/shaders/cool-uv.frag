...
================================
  ...
  Here i use 0-255 for the colors just because Visual Code adds a beautiful colored square to visualize the color this way:
    Left bottom corner is (0, 0) => rgb(0, 0, 1.0) 
    Right top corner is (1, 1) => rgb(1.0, 1.0, 1.0)
    Right Left Corner is (0, 1) => rgb(0, 1.0, 1.0)
    Left Top Corner is (1, 0) => rgb(1.0, 0, 1.0)
*/
void main() {
